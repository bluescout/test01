...
The repository contains simple agent code with metrics collector for Windows, with no tests, no central node or frontend yet. As for now, I've spent about 5h gross, including env setup.
